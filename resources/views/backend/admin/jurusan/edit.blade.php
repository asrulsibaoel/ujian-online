@extends('master')
@section('title')
    <title>Update Jurusan - UJIAN ONLINE</title>
@stop
@section('text-info')
    <h1>Update Jurusan
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active"><a> Update Jurusan</a></li>
    </ol>
@stop
@section('content')
            ...
            <div class="panel-body" id="kontainer">
                <div class="panel panel-default" style="border: 1px solid #346357; border-radius: 0px">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        {!! Form::model($jurusan, ['class' => 'form-horizontal form-label-left', 'method' => 'patch', 'action' => ['JurusanController@update', $jurusan->id_jurusan]]) !!}<!-- start form -->
                        {!! Form::token() !!}

                        <div class="row">
                            <div class="form-group">
                                {!! Form::label('jurusan', 'Jurusan ', ['class' => 'control-label col-md-offset-1 col-md-3 col-sm-1 col-xs-12'])!!}
                        ...
                        <div class="row">
                            <div class="col-md-offset-4 col-md-4">
                                ...
                                <a class="btn btn-default" id="cancel"
                                   href="{{url('index/manajemen/jurusan')}}">Cancel</a>
                            </div>
                        </div>
                        {!! Form::close() !!}
                    </div>
