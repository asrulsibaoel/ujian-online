@extends('master')
@section('title')
<title>Update Ujian - UJIAN ONLINE</title>
@stop
@section('text-info')
<h1>Update Ujian
</h1>
<ol class="breadcrumb">
    ...
    <li class="active"><a> Update Ujian</a></li>
</ol>
@stop
@section('content')
        ...
        <div class="panel-body" id="kontainer">
            <div class="panel panel-default" style="border: 1px solid #346357; border-radius: 0px">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    {!! Form::model($ujian, ['class' => 'form-horizontal form-label-left', 'method' => 'patch', 'action' => ['ujianController@update',$ujian->id_ujian]]) !!}<!-- start form -->
                    {!! Form::token() !!}
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                {!! Form::select('kkm', $kkm, null, ['class' => 'form-control'])!!}
                            </div>
                        </div>
                    </div>
                    <!--
